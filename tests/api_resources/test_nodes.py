...
class TestAsyncNodes:
    ...
    @parametrize
    async def test_method_create(self, async_client: AsyncCript) -> None:
    ...
    @parametrize
    async def test_raw_response_create(self, async_client: AsyncCript) -> None:
    ...
    @parametrize
    async def test_streaming_response_create(self, async_client: AsyncCript) -> None:
    ...
    @parametrize
    async def test_path_params_create(self, async_client: AsyncCript) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `node` but received ''"):
            await async_client.nodes.with_raw_response.create(
                "string",
                node="",
                body={
                    "node": ["Project"],
    ...
    @parametrize
    async def test_method_update(self, async_client: AsyncCript) -> None:
    ...
    @parametrize
    async def test_raw_response_update(self, async_client: AsyncCript) -> None:
    ...
    @parametrize
    async def test_streaming_response_update(self, async_client: AsyncCript) -> None:
    ...
    @parametrize
    async def test_path_params_update(self, async_client: AsyncCript) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `node` but received ''"):
    ...
    @parametrize
    async def test_method_delete(self, async_client: AsyncCript) -> None:
    ...
    @parametrize
    async def test_raw_response_delete(self, async_client: AsyncCript) -> None:
    ...
    @parametrize
    async def test_streaming_response_delete(self, async_client: AsyncCript) -> None:
    ...
    @parametrize
    async def test_path_params_delete(self, async_client: AsyncCript) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `node` but received ''"):
