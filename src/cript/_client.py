...
from ._exceptions import CriptError, APIStatusError
...
class AsyncCript(AsyncAPIClient):
    schema: resources.AsyncSchemaResource
    nodes: resources.AsyncNodesResource
    search: resources.AsyncSearchResource
    controlled_vocabularies: resources.AsyncControlledVocabulariesResource
    with_raw_response: AsyncCriptWithRawResponse
    with_streaming_response: AsyncCriptWithStreamedResponse
    ...
    def __init__(
        ...
        *,
        ...
        self.controlled_vocabularies = resources.AsyncControlledVocabulariesResource(self)
        self.with_raw_response = AsyncCriptWithRawResponse(self)
        self.with_streaming_response = AsyncCriptWithStreamedResponse(self)
...
class CriptWithRawResponse:
    def __init__(self, client: Cript) -> None:
        ...
        self.controlled_vocabularies = resources.ControlledVocabulariesResourceWithRawResponse(
            client.controlled_vocabularies
        )


class AsyncCriptWithRawResponse:
    def __init__(self, client: AsyncCript) -> None:
        ...
        self.controlled_vocabularies = resources.AsyncControlledVocabulariesResourceWithRawResponse(
            client.controlled_vocabularies
        )


class CriptWithStreamedResponse:
    def __init__(self, client: Cript) -> None:
        ...
        self.controlled_vocabularies = resources.ControlledVocabulariesResourceWithStreamingResponse(
            client.controlled_vocabularies
        )


class AsyncCriptWithStreamedResponse:
    def __init__(self, client: AsyncCript) -> None:
        ...
        self.controlled_vocabularies = resources.AsyncControlledVocabulariesResourceWithStreamingResponse(
            client.controlled_vocabularies
        )
